...
.footer p {
    ...
    opacity: 0.8;
        ...
        .btn-secondary {
            background: linear-gradient(135deg, var(--secondary-color), #38c9a9);
            color: white;
        }
        ...
        .btn-secondary:hover {
            transform: translateY(-2px);
            box-shadow: 
                0 6px 20px rgba(80, 227, 194, 0.4),
                inset 0 1px 0 rgba(255, 255, 255, 0.4);
        }
    ...
    <div class="container">
        <div class="header">
            <div class="social-links">
                <a href="${atob("aHR0cHM6Ly9naXRodWIuY29tL2NobmJzZGFuL2VkZ2V0dW5uZWw=")}" target="_blank" class="social-link" title="GitHub">
                ...
                <a href="${atob("aHR0cHM6Ly90Lm1lL2Jlbl9tZXNh")}" target="_blank" class="social-link" title="Telegram">
            ...
            <h1 id="pageHeader">edgetunnel 配置中心</h1>
        </div>
